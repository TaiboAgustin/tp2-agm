...
public class LocalidadTest {
    ...
    @Test
    public void equalsConMismosDatosEsTrue() {
        Localidad l1 = new Localidad("CABA","Buenos Aires",-34.6, -58.4);
        Localidad l2 = new Localidad("CABA","Buenos Aires",-34.6,-58.4);
        assertTrue(l1.equals(l2));
    }
    @Test
    public void equalsConDatosDistintosEsFalse() {

        Localidad l1 = new Localidad("CABA","Buenos Aires",-34.6,-58.4);
        Localidad l2 = new Localidad("Cordoba","Cordoba",-31.4,-64.2);
        assertFalse(l1.equals(l2));
    }
    @Test
    public void equalsMismoObjetoEsTrue() {
    ...
    @Test
    public void equalsConNullEsFalse() {
    ...
    @Test
    public void equalsConOtroTipoEsFalse() {
        ...
        assertFalse(l1.equals("hola"));
    }
    @Test
    public void hashCodeIgualesSonIguales() {
